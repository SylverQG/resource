...
从 Release 下载第16-17章背景建模与光流估计的数据包 test.avi.zip 并解压到当前目录。

Release 地址（见 readme.md）:
    https://gitee.com/SylverQG/resource/releases/tag/data-02-test
...
# Release 附件下载直链（test.avi.zip）
DOWNLOAD_URL = (
    "https://gitee.com/SylverQG/resource/releases/download/"
    "data-02-test/test.avi.zip"
)

# 解压目标目录（当前脚本所在目录，即 第16-17章 目录）
TARGET_DIR = os.path.dirname(os.path.abspath(__file__))

ZIP_NAME = "test.avi.zip"
...
def main() -> None:
    ...
    try:
        ...
        print("请删除 test.avi.zip 后重新运行本脚本。", file=sys.stderr)
        sys.exit(1)
